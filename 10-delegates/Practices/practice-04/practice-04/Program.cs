...
namespace practice_01
{
    ...
    public class whileAndSwitchCase
    {
        ...
        public static int newInterest { get; set; }
        ...
        public delegate void skipAmountOper(int a, int b);
        ...
        {
            newInterest = (a * 9 * b) / (365 * 100);
            Console.WriteLine($"You were accrued percent in the amount: {newInterest}");

            dict[100] = (FirstName, LastName, AccountType, a+newInterest);
        ...
        public void whileClass()
        {
            ...
            var del_obj3 = new skipAmountOper(obj.multiplication);
            ...
            while (truefalse)
            {
                ...
                switch (outputBool)
                {
                    ...
                    case 5:
                        Console.WriteLine("Enter account number: ");
                        int.TryParse(Console.ReadLine(), out int userIdentifyWithSkip);
                        foreach (KeyValuePair<int, (string a, string b, string c, int d)> item in dict)
                        {
                            if (item.Key == userIdentifyWithSkip)
                            {
                                Console.WriteLine($"Welcome {item.Value.a} {item.Value.b} !");
                            }
                            case2 = item.Value.d;
                        ...
                        Console.WriteLine("EXSISTING AMOUNT OF MONEY: " + case2);
                        printSkipMenu();
                        int.TryParse(Console.ReadLine(), out int SwitchCaseSkip);
                        switch (SwitchCaseSkip)
                        {
                            case 1:
                                del_obj3(case2, 1);
                                break;
        ...
        public void printMenu()
        {
            ...
            Console.WriteLine("5. Skip The Period");
            Console.WriteLine("0. Exit the program");
            Console.WriteLine("==================================");
            Console.WriteLine("Select an action: ");
        }

        public void printSkipMenu()
        {
            Console.WriteLine("==================================");
